    ...
    function BaseGroupboxFuncs:AddButton(...)
        ...
        local function CreateBaseButton(Button)
            ...
            if Button.Warning then
                local WarningIcon = Library:Create('TextLabel', {
                    BackgroundTransparency = 1,
                ...
                if typeof(Button.Message) == "string" then
                    local WarningTooltip = Library:AddToolTip(Button.Message, nil, WarningIcon)
                    if WarningTooltip and WarningTooltip.Backing then
                        WarningTooltip.Backing.BackgroundColor3 = Color3.fromRGB(255, 220, 100) -- yellow
                        WarningTooltip.Label.TextColor3 = Color3.fromRGB(0, 0, 0) -- black text
                    end
                end
